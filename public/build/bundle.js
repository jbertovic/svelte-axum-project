...
(function () {
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$3, 64, 30, 1849);
    			add_location(strong, file$3, 65, 31, 1887);
    			add_location(div, file$3, 63, 4, 1813);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 41, 12, 1162);
    			attr_dev(input0, "class", "input");
    			attr_dev(input0, "type", "username");
    			attr_dev(input0, "placeholder", "username");
    			add_location(input0, file$3, 42, 16, 1217);
    			attr_dev(label1, "for", "password");
    			add_location(label1, file$3, 48, 12, 1410);
    			attr_dev(input1, "class", "input");
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file$3, 49, 16, 1465);
    			add_location(div0, file$3, 40, 8, 1144);
    			add_location(button, file$3, 57, 16, 1691);
    			add_location(div1, file$3, 56, 8, 1669);
    			add_location(div2, file$3, 34, 4, 1021);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 36, 12, 1066);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if_block.c();
    			add_location(div, file$2, 17, 0, 464);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ user, onMount, errorMessage, $user });
    ...
    const file$1 = "src_front/pages/Secure.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("\n");
    			add_location(p, file$1, 19, 0, 488);
    			add_location(pre, file$1, 21, 0, 517);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		if (secureResponse.result == "unauthorized") {
    			...
    			$$invalidate(0, response = JSON.stringify(secureResponse));
    		}
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 60, 0, 1288);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("Logged In as ");
    			t1 = text(/*$user*/ ctx[0]);
    			add_location(h4, file, 50, 2, 1128);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file, 48, 2, 1093);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    		},
